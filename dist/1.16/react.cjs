...
// src/versions/1.16/react.ts
var react_exports = {};
__export(react_exports, {
  ITEM_CATEGORIES: () => ITEM_CATEGORIES,
  MINECRAFT_ITEMS: () => MINECRAFT_ITEMS,
  MINECRAFT_VERSION: () => MINECRAFT_VERSION,
  MinecraftItemIcon: () => MinecraftItemIcon,
...
function MinecraftItemIcon({
  ...
  const [imageUrl, setImageUrl] = (0, import_react.useState)(
    () => getTextureUrl2(itemId, nbtData, textureBaseUrl)
  );
  (0, import_react.useEffect)(() => {
    setImageUrl(getTextureUrl2(itemId, nbtData, textureBaseUrl));
    setHasError(false);
  ...
  if (hasError && showFallbackOnError) {
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
      "div",
      {
        ...
        title: itemId,
        ...props,
        children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { style: { filter: "drop-shadow(0 1px 2px rgba(0,0,0,0.3))" }, children: emoji })
      }
    );
  }
  return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
