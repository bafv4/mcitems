...
// src/versions/1.16/vue.ts
var vue_exports = {};
__export(vue_exports, {
  ITEM_CATEGORIES: () => ITEM_CATEGORIES,
  MINECRAFT_ITEMS: () => MINECRAFT_ITEMS,
  MINECRAFT_VERSION: () => MINECRAFT_VERSION,
  MinecraftItemIcon: () => MinecraftItemIcon_default,
  ...
  formatPotionName: () => formatPotionName,
  getAllItems: () => getAllItems,
  getCraftableItems: () => getCraftableItems,
  getCraftableItemsByCategory: () => getCraftableItemsByCategory,
  getItemNameJa: () => getItemNameJa,
...
// src/versions/1.16/MinecraftItemIcon.vue
...
function getItemEmoji(itemId) {
  ...
  if (itemName.includes("axe")) return "\u{1FA93}";
  if (itemName.includes("shovel")) return "\u{1F3D7}\uFE0F";
  if (itemName.includes("hoe")) return "\u{1F33E}";
  if (itemName.includes("sword")) return "\u2694\uFE0F";
  if (itemName.includes("helmet")) return "\u{1FA96}";
  if (itemName.includes("chestplate")) return "\u{1F9BA}";
  if (itemName.includes("leggings")) return "\u{1F456}";
  if (itemName.includes("boots")) return "\u{1F462}";
  if (itemName.includes("apple")) return "\u{1F34E}";
  if (itemName.includes("bread")) return "\u{1F35E}";
  if (itemName.includes("meat") || itemName.includes("beef") || itemName.includes("porkchop"))
    return "\u{1F356}";
  if (itemName.includes("fish") || itemName.includes("cod") || itemName.includes("salmon"))
    return "\u{1F41F}";
  if (itemName.includes("carrot")) return "\u{1F955}";
  if (itemName.includes("potato")) return "\u{1F954}";
  if (itemName.includes("stone") || itemName.includes("cobblestone"))
    return "\u{1FAA8}";
  if (itemName.includes("wood") || itemName.includes("log") || itemName.includes("planks"))
    return "\u{1FAB5}";
  if (itemName.includes("glass")) return "\u{1F532}";
  if (itemName.includes("dirt") || itemName.includes("grass")) return "\u{1F7EB}";
  if (itemName.includes("wool")) return "\u{1F9F6}";
  if (itemName.includes("iron_bars")) return "\u{1F512}";
  if (itemName.includes("diamond")) return "\u{1F48E}";
  if (itemName.includes("emerald")) return "\u{1F49A}";
  if (itemName.includes("gold")) return "\u{1F7E1}";
  if (itemName.includes("iron")) return "\u2699\uFE0F";
  if (itemName.includes("book")) return "\u{1F4D6}";
  if (itemName.includes("potion")) return "\u{1F9EA}";
  if (itemName.includes("bow")) return "\u{1F3F9}";
  if (itemName.includes("arrow")) return "\u27A1\uFE0F";
  if (itemName.includes("bed")) return "\u{1F6CF}\uFE0F";
  if (itemName.includes("chest")) return "\u{1F4E6}";
  if (itemName.includes("door")) return "\u{1F6AA}";
  if (itemName.includes("torch")) return "\u{1F526}";
  if (itemName.includes("bucket")) return "\u{1FAA3}";
  if (itemName.includes("respawn_anchor")) return "\u2693";
  if (itemName.includes("lodestone")) return "\u{1F9F2}";
  if (itemName.includes("campfire")) return "\u{1F525}";
  if (itemName.includes("lantern")) return "\u{1F3EE}";
  return "\u{1F4E6}";
}

// src/versions/1.16/MinecraftItemIcon.vue
var _hoisted_1 = ["title"];
var _hoisted_2 = { style: { "filter": "drop-shadow(0 1px 2px rgba(0, 0, 0, 0.3))" } };
var _hoisted_3 = ["src", "alt"];
var TEXTURE_PATH = "1.16.1/items";
var MinecraftItemIcon_default = /* @__PURE__ */ (0, import_vue.defineComponent)({
  props: {
    itemId: { type: String, required: true },
    size: { type: Number, required: false, default: 48 },
    showFallbackOnError: { type: Boolean, required: false, default: true },
    nbtData: { type: Object, required: false },
    textureBaseUrl: { type: String, required: false, default: "" }
  },
  setup(__props) {
    const props = __props;
    const hasError = (0, import_vue3.ref)(false);
    ...
    const imageUrl = (0, import_vue3.computed)(
      () => getTextureUrl2(props.itemId, props.nbtData, props.textureBaseUrl)
    );
    const fallbackColor = (0, import_vue3.computed)(() => getItemColor(props.itemId));
    const fallbackEmoji = (0, import_vue3.computed)(() => getItemEmoji(props.itemId));
    (0, import_vue3.watch)(
      () => props.itemId,
      () => {
    ...
    return (_ctx, _cache) => {
      return hasError.value && __props.showFallbackOnError ? ((0, import_vue2.openBlock)(), (0, import_vue2.createElementBlock)("div", {
        key: 0,
        class: "minecraft-item-icon-fallback",
        style: (0, import_vue2.normalizeStyle)({
          width: `${__props.size}px`,
          height: `${__props.size}px`,
          backgroundColor: fallbackColor.value,
          fontSize: `${__props.size * 0.5}px`,
          display: "flex",
          alignItems: "center",
        ...
        title: __props.itemId
      }, [
        (0, import_vue2.createElementVNode)(
          "span",
          _hoisted_2,
          (0, import_vue2.toDisplayString)(fallbackEmoji.value),
          1
          /* TEXT */
        )
      ], 12, _hoisted_1)) : ((0, import_vue2.openBlock)(), (0, import_vue2.createElementBlock)("img", {
        key: 1,
        src: imageUrl.value,
        alt: __props.itemId,
...
var TEXTURE_PATH2 = "1.16.1/items";
...
function getTextureUrl(itemId, nbtData, baseUrl = "") {
  ...
  const fileName = normalizedId.replace("minecraft:", "minecraft_");
  return `${baseUrl}/${TEXTURE_PATH2}/${fileName}.png`;
}
