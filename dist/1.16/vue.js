...
var MinecraftItemIcon_default = /* @__PURE__ */ _defineComponent({
  props: {
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return hasError.value && __props.showFallbackOnError ? (_openBlock(), _createElementBlock("div", {
        key: 0,
        ...
        _createElementVNode(
          "span",
          _hoisted_2,
          _toDisplayString(fallbackEmoji.value),
          1
          /* TEXT */
        )
      ], 12, _hoisted_1)) : (_openBlock(), _createElementBlock("img", {
        key: 1,
        src: imageUrl.value,
        alt: __props.itemId,
...
export {
  ...
  MINECRAFT_ITEMS,
  MINECRAFT_VERSION,
  MinecraftItemIcon_default as MinecraftItemIcon,
  POTION_EFFECTS,
  POTION_EFFECT_TO_TEXTURE,
  POTION_VARIANTS,
  TEXTURE_PATH2 as TEXTURE_PATH,
  formatItemName,
  formatPotionEffect,
  formatPotionName,
  getAllItems,
